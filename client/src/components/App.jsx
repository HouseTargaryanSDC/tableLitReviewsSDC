...
class App extends Component {
  ...
  getAllReviews = () => {
    return Axios.get(`http://13.57.250.60:9000/api/reviews/all/${this.state.restaurantId}`)
      .then(({data}) => {
  ...
  getReviewsSummary = () => {
    return Axios.get(`http://13.57.250.60:9000/api/reviews/summary/${this.state.restaurantId}`)
      .then(({data}) => {
